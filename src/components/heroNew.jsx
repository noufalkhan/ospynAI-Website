      ...
      <div className='w-full pt-16  sm:px-10 md:px-5 lg:px-0 bg-gradient-to-r from-[#eee6ff] via-transparent to-[#ffe2f9]'>
        ...
        >
          ...
          >
            ...
            <motion.p className='text-black text-base w-3/4 lg:pr-5 md:w-full text-center md:text-start  my-2 md:my-5' variants={subtleFadeIn}>
          ...
          <motion.div
            className='h-auto md:h-full w-full flex flex-col items-center justify-end sm:hidden  xl:flex mt-5 md:mt-20'
            initial='hidden'
            animate='visible'
            variants={subtleFadeIn}
          >
